                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          <!-- Current avatar -->
                          <img class="img-responsive avatar-view" src="{{ url('assets/production/images/users')}}/{{\App\User::where('employee_id',$userid)->orWhere('email',$userid)->get()->first()->image}}" alt="Avatar" title="Change the avatar">
                        </div>
                      </div>
                      <h3>{{ App\User::where('employee_id',$userid)->orWhere('email',$userid)->get()->first()->name}}</h3>

                      <ul class="list-unstyled user_data">
                        <li><i class="fa fa-map-marker user-profile-icon"></i> Bang Pa-In, Ayutthaya, Thailand
                        </li>

                        <li>
                          <i class="fa fa-briefcase user-profile-icon"></i> Staff Engineer
                        </li>

                        <li class="m-top-xs">
                          <i class="fa fa-external-link user-profile-icon"></i>
                          <a href="http://www.wdc.com/" target="_blank">www.wdc.com</a>
                        </li>
                      </ul>
                          ...
                          <div role="tabpanel" class="tab-pane fade" id="tab_content1" aria-labelledby="home-tab">
                            ...
                            <ul class="messages">
                              <li>
                                ...
                                <img src="{{ url('assets/production/images/users/guest.png')}}" class="avatar" alt="Avatar">
