    ...
    <div class="form-horizontal form-label-left">
      ...
      <div class="form-group">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
          <input name="tbx_software_name" id="tbx_software_name" disabled="disabled" type="text" class="form-control" placeholder="Software Name" value="{{ $record[0]->master_rev }}">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
          <select name="ddl_product_name" id="ddl_product_name" disabled="disabled" class="select2_single form-control" tabindex="-1">
            <option>{{ $record[0]->product_name }}</option>
      ...
      <div class="form-group">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
          <select name="ddl_software_status" id="ddl_software_status" class="select2_single form-control" tabindex="-1">
            <option>{{ $record[0]->sw_status }}</option>
      ...
      <div class="form-group">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
          <select name="ddl_software_step" id="ddl_software_step" class="select2_single form-control" tabindex="-1">
            <option>{{ $record[0]->sw_status_desc }}</option>
      ...
      <div class="form-group">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
          <select name="ddl_operation" id="ddl_operation" disabled="disabled" class="select2_single form-control" tabindex="-1">
            <option>{{ $record[0]->operation }}</option>
      ...
      <div class="form-group">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
          <select name="ddl_platform" id="ddl_platform" disabled="disabled" class="select2_single form-control" tabindex="-1">
            <option>{{ $record[0]->platform }}</option>
      ...
      <div class="form-group">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
          <input name="tbx_tester" id="tbx_tester" type="text" class="form-control" placeholder="Tester" value="{{ $record[0]->tester }}">
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
          <a href="{{ url('platform') . '/' . ($record[0]->platform) }}" class="btn btn-primary" role="Add">Cancel</a>
...
<script>
  $("#update").click(function()
  {
    ...
    $.post("{{ route('platform.update') }}",
    {
      ...
      //console.log(data);
      if(data){
        var url= "{{ url('platform') }}";
        window.location=url+'/'+$("#ddl_platform").val();
      }
    });
  });
</script>
