    ...
    <div class="form-horizontal form-label-left">
      ...
      <div class="form-group">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
          <input name="tbx_software_name" id="tbx_software_name" type="text" class="form-control" placeholder="Software Name" value="{{ $record[0]->master_rev }}">
        </div>
      </div>
...
<script>
  $("#update").click(function()
  {
    var _id = "{{$id}}";
    //console.log(_id);
    $.post("{{ route('software_detail.update') }}",
    {
      id:_id,
